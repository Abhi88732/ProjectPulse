      ...
      <div class="col-md-3 col-lg-4">
        <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
          <figure class="portfolio-item">
            ...
            <img class="img-responsive" src="./FolderForDesign/ClientImage/${e.company.CProfileFile}" alt="" width=300px>
              <div class="overlay"></div><!-- / overlay -->
            </a><!-- / hovereffect -->
          </figure><!-- / portfolio-item -->
          <div class="card-body">
            <a  class="card-title title-link fs-16 fw-bold" style="font-size: 24px;">${e.company.CName}</a>
            <br>
            <a href="single-project6.html" class="card-title title-link fs-16 fw-bold">${e.PJTitle}</a>
            <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>${e.PJSkills}</p>
    ...
    <c:forEach items="${projectdata}" var="e">
      ...
      <div class="col-md-3 col-lg-4">
        <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
          ...
          <div class="card-body">
            <a  class="card-title title-link fs-16 fw-bold" style="font-size: 24px;">${e.PTitle}</a>
            <br>
            <a href="single-project6.html" class="card-title title-link fs-16 fw-bold">${e.PName}</a>
            <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>${e.PSkills}</p>
            
            <center><a href="viewAndApply/${e.PId}"><button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button></a></center>
