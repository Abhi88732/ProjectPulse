            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="./FolderForDesign/images/pngwing.com.png" alt="">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-md-3 col-lg-4">
        <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
          ...
          <div class="card-body">
            ...
            <center><a href="viewAndApplyProject/${e.PId}"><button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button></a></center>
            
             <a href="./FolderForDesign/ClientImage/${e.PFilePdf}" class="download-button" download="ProjectPlus Documentation.PDF">
