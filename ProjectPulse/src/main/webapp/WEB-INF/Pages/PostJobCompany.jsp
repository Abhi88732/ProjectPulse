  ...
  <body>
    ...
    <div class="colums">
        <div class="item">
            ...
            <textarea id="jobDescription" name="PJDescription" rows="4" cols="50"></textarea>
        </div>
        <div class="item">
            <label for="lname">Job Title<span>*</span></label>
            <input type="text" id="jobTitle" name="PJTitle" placeholder="Software Engineer" required />
        </div>
        <br><br>
        <div class="item">
            ...
            <input id="skills" name="PJSkills" required />
        ...
        <div class="question">
            ...
            <div class="question-answer">
                <div>
                    <input type="radio" value="Full Time Role" id="radio_1" name="PJRole" required />
                    <label for="radio_1" class="radio"><span>Full Time Role</span></label>
                </div>
                <div>
                    <input type="radio" value="Freelancing" id="radio_2" name="PJRole" required />
        ...
        <div class="question">
            ...
            <input type="text" id="budget" name="PJSalary" placeholder="10000,20000" required title="Please enter a valid number." />
            <c:forEach items="${CompanyData}" var="CD">
                <input type="hidden" name="PJName" value="${CD.CName}" />
                <input type="hidden" name="PJEmail" value="${CD.CEmail}" />
            </c:forEach>
            <br>
        </div>
        <h4>${messaage}</h4>
