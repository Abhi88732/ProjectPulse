...
<html lang="en">
  ...
  <body>
    ...
    <form id="freelancerForm" action="SaveFreelancerData" class="form" method="post" enctype="multipart/form-data">
    <div class="column">
        <div class="input-box">
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter phone number" name="FNumber" required pattern="\d{10,15}" title="Please enter a valid phone number with 10-15 digits." />
        </div>
        <div class="input-box">
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="url" placeholder="Enter Your LinkedIn Username/Link" required name="FLinkdin" />
        </div>
        <div class="input-box">
    ...
    <div class="column">
        <div class="form-group file-area input-box">
            ...
            <input type="file" name="FPProfileFile" id="fprofilephoto" accept="image/*" required />
        </div>
        <div class="input-box">
    ...
    <div class="gender-box">
        ...
        <div class="gender-option">
            <div class="gender">
                <input type="radio" id="check-male" name="FGender" value="Male" checked />
                <label for="check-male">Male</label>
            </div>
            <div class="gender">
                <input type="radio" id="check-female" name="FGender" value="Female" />
                <label for="check-female">Female</label>
            </div>
            <div class="gender">
                <input type="radio" id="check-other" name="FGender" value="Prefer not to say" />
    ...
    <select id="skill1" name="FSkills" style="font-size:20px;" required>
    ...
    <select id="skill2" name="FSkills" style="font-size:20px;" required>
        <option hidden></option>
        <option value="Design & Arts">Design & Arts</option>
        <option value="Web Development">Web Development</option>
        <option value="SEO Marketing">SEO Marketing</option>
    ...
    <select id="skill3" name="FSkills" style="font-size:20px;" required>
        <option hidden></option>
        <option value="Design & Arts">Design & Arts</option>
        <option value="Web Development">Web Development</option>
        <option value="SEO Marketing">SEO Marketing</option>
    ...
    <select id="skill4" name="FSkills" style="font-size:20px;" required>
        <option hidden></option>
        <option value="Design & Arts">Design & Arts</option>
        <option value="Web Development">Web Development</option>
        <option value="SEO Marketing">SEO Marketing</option>
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="password" placeholder="Enter Account Password" required name="FPassword" />
        </div>
        <div class="input-box">
            <label>Confirm Password</label>
            <input type="password" placeholder="Enter Confirm Password" required name="FCPassword" />
        </div>
    </div>
