...
<body>
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="./FolderForDesign/images/pngegg.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="row boxed-portfolio">
    <!-- Project Cards -->
    <c:forEach items="${ShowCompanyData}" var="ShowData">
      ...
      <div class="col-md-3 col-lg-4">
        <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
          <figure class="portfolio-item">
            ...
            <img class="img-responsive" src="./FolderForDesign/ClientImage/${ShowData.company.CProfileFile}" alt="" width=300px>
              <div class="overlay"></div><!-- / overlay -->
            </a><!-- / hovereffect -->
          </figure><!-- / portfolio-item -->
          <div class="card-body">
            <a  class="card-title title-link fs-16 fw-bold" style="font-size: 24px;">${ShowData.PJName}</a>
            <br>
           
            <a href="single-project6.html" class="card-title title-link fs-16 fw-bold">${ShowData.PJTitle}</a>
            <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>${ShowData.PJSkills}</p>
            <center><a href="viewAndApply/${ShowData.PJId}"><button type="button" class="btn btn-primary">View and Apply</button></a></center>
          </div><!-- / card-body -->
        </div><!-- / card -->
      </div><!-- / col-md-6 -->
    </c:forEach>
