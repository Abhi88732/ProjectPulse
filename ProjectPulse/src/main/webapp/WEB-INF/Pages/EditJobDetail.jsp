...
<html>
  ...
  <body>
    ...
    <c:forEach items="${jobdata}" var="e">
      <form action="/ProjectPulse/UpdateJobData" method="post">
        <div class="banner">
      <h1>Post job <i class="fa-solid fa-briefcase"></i> ,What you need done?</h1>
        ...
        <div class="colums">
          <div class="item">
            ...
            <textarea id="myTextArea" name="PJDescription" rows="4"  cols="50">
              ${e.PJDescription}
          </textarea>
          </div>
          <div class="item">
            <label for="lname">Job Tittle<span>*</span></label>
            <input type="text" id="fileInput" name="PJTitle" value=" ${e.PJTitle}" placeholder="Software Engineer">
             <br>
          ...
          <div class="item">
            ...
            <input id="address1" height="50px"  value=" ${e.PJSkills}"   name="PJSkills" required/>
            <h6>Suggested skills:
              MySQL,
              Web Hosting,
              Software Testing,
        ...
        <div class="question">
          ...
          <div class="question-answer">
            <div>
              <input type="radio" value="Full Time Role"  id="radio_1" name="PJRole"/>
              <label for="radio_1"  class="radio"><span>Full Time Role</span></label>
            </div>
            <div>
              <input  type="radio" value="Freelancing" id="radio_2" name="PJRole" />
        ...
        <div class="question">
          <label>What is your estimated budget or Salary?</label>
           <input  type="text"  name="PJSalary" value=" ${e.PJSalary}" placeholder="10000,20000"/>
           
          
            <input  type="text"  name="PJName" value="${e.PJName}"/ readonly>
            
             <input  type="text"  name="PJEmail" value="${e.PJEmail}"/ readonly>
             
              <input  type="hidden"  name="PJId" value="${e.PJId}"/ readonly>
