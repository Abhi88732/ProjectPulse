...
<html lang="en">
  ...
  <body>
    ...
    <div class="input-box">
        ...
        <input type="email" placeholder="Enter Your email address" name="CEmail" required />
    </div>

    <br>
    <div class="input-box">
        <label>Enter Password</label>
        <input type="password" placeholder="Enter Your Password" name="CPassword" required pattern=".{8,}" title="Password must be at least 8 characters long." />
    </div>
