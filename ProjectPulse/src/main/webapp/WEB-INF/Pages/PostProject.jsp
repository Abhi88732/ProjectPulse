  ...
  <body>
    ...
    <div class="colums">
        <div class="item">
            ...
            <textarea id="projectDescription" name="PDetails" rows="4" cols="50" ></textarea>
        </div>
        <div class="item">
            <label for="projectt">Project Title<span>*</span></label>
            <input type="text" id="projectTitle" name="PTitle" placeholder="AI Chat bot" />
        </div>
        <div class="item">
        ...
        <div class="item">
            ...
            <input id="skills" name="PSkills" required />
        ...
        <div class="question">
            ...
            <input type="text" id="budget" name="PBudget" placeholder="10000,20000" title="Please enter a valid number." required />
        </div>
        <br>
        <br>
         <br>
        ...
        <c:forEach items="${CompanyData}" var="e">
            ...
            <input type="hidden" name="PName" value="${e.CName}" readonly />
            <label>Company Email</label>
            <input type="hidden" name="PEmail" value="${e.CEmail}" readonly />
        </c:forEach>
        <br>
        <h4>${message}</h4>
...
document.getElementById('postProjectForm').addEventListener('submit', function(event) {
    ...
    var projectDescription = form.elements['PDetails'].value.trim();
    var projectTitle = form.elements['PTitle'].value.trim();
    var skills = form.elements['PSkills'].value.trim();
    var budget = form.elements['PBudget'].value.trim();
