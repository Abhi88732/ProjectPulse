        ...
        <div class="card-box">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./FolderForDesign/ClientImage/${e.FPProfile}" class="rounded-circle img-thumbnail" alt="profile-image">
                </div>
                <input type="hidden" value="${e.FId}">
                <div>
                    <h4>${e.FName}</h4>
                     <h6>${e.FEmail}</h6>
                    <p class="text-muted">Skills<span><i class="fa-brands fa-nutritionix"></i><br> </span><span><a href="#" class="text-pink">${e.FSkills}</a></span></p>
                </div>
              <a href="${e.FLinkdin}" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;""><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
